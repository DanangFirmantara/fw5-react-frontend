					...
					<div className="container my-5">
						...
						<div className='row justify-content-around'>
							...
							<div className='col-6'>
								...
								<div>
									<div className="pd-heading fw-light fs-1 mb-3">{vehicle.dataDetail?.location}</div>
								</div>
								<div>
						...
						<div className='row justify-content-around'>
							<div className='col-5 border border-3 py-4 border-grey rounded mb-4'>
								<div className='mx-4 d-flex align-items-center'>
									<div className='fw-bold fs-5'>Quantity : <span className='fw-normal'>{} {}</span> </div>
								</div>
							</div>
							<div className='col-6 border border-3 py-4 border-grey rounded mb-4 '>
								<div className='d-flex align-items-center mx-4'>
									<div className='fw-bold fs-5'>
								Reservation Date : <span className='fw-normal'>{}</span> 
									</div>
								</div>
							</div>
						</div>
							...
							<div className='col-5 border border-3 py-4 border-grey rounded mb-4'>
								<div className='d-flex align-items-center'>
									<div className='mx-4 '>
										...
										<div className="fs-4"> : Rp. {new Intl.NumberFormat('de-DE').format(1000)}</div>
										<div className="fw-bolder fs-4 mt-3">Total : {new Intl.NumberFormat('de-DE').format(1000)}</div>
									</div>
								</div>
							</div>
							<div className='col-6 border border-3 py-4 border-grey rounded mb-4'>
